        ...
        <div class="max-h-96 overflow-y-auto divide-y divide-gray-50">
            ...
            @empty
                <div class="px-4 py-12 text-center">
                    <div
                        class="w-12 h-12 bg-[--color-bg-inset] rounded-2xl flex items-center justify-center mx-auto mb-3">
                        <svg class="w-6 h-6 text-[--color-text-muted]" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
