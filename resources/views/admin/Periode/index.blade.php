<x-app-layout :title="$title" :subtitle="$subtitle">
    ...
    <div class="max-w-7xl mx-auto pb-6" x-data="{ showDeleteModal: false, deleteUrl: '' }">
                ...
                <table class="w-full text-xs text-left">
                    <thead>
                        <tr class="bg-slate-50/80 border-b border-slate-100">
                            ...
                            <th class="px-4 py-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider w-36">
                                Status
                            </th>
                            <th
                                ...
                                <td class="px-5 py-3 text-right whitespace-nowrap">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @if ($periode->canDelete())
                                            <button type="button"
                                                @click="deleteUrl = '{{ route('admin.periode.destroy', $periode) }}'; showDeleteModal = true;"
                                                title="Hapus periode (hanya jika semua laporan masih draft)"
                                                class="inline-flex items-center justify-center gap-1 px-3 py-1.5 bg-white hover:bg-rose-50 border border-slate-200 hover:border-rose-200 text-[10px] text-slate-700 hover:text-rose-700 font-bold rounded-lg transition-all shadow-sm group-hover:shadow focus:ring-2 focus:ring-rose-100">
                                                <svg class="w-3.5 h-3.5 text-slate-400 group-hover:text-rose-500 transition-colors"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <tr>
                                <td colspan="6" class="px-4 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <h3 class="text-sm font-bold text-slate-800 mb-0.5">Belum Ada Siklus Periode
                                        </h3>
        ...
        <div x-cloak x-show="showDeleteModal" class="relative z-50" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div x-show="showDeleteModal" @click.away="showDeleteModal = false" 
                        ...
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 class="text-base font-bold leading-6 text-slate-900" id="modal-title">Hapus Periode Permanen?</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-slate-500 leading-relaxed">Tindakan ini tidak dapat dibatalkan. Seluruh laporan yang terhubung dengan periode ini akan ikut terhapus dari sistem.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-slate-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 border-t border-slate-100">
                            <form method="POST" :action="deleteUrl" class="inline-flex w-full sm:w-auto">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="inline-flex w-full justify-center rounded-lg bg-rose-600 px-4 py-2 text-sm font-bold text-white shadow-sm hover:bg-rose-500 sm:ml-3 sm:w-auto transition-colors focus:ring-4 focus:ring-rose-100">Ya, Hapus</button>
                            </form>
                            <button type="button" @click="showDeleteModal = false" class="mt-3 inline-flex w-full justify-center rounded-lg bg-white px-4 py-2 text-sm font-bold text-slate-700 shadow-sm ring-1 ring-inset ring-slate-300 hover:bg-slate-50 sm:mt-0 sm:w-auto transition-colors">Batal</button>
                        </div>
                    </div>
                </div>
            </div>
